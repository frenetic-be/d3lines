...
Here you can find all options related to the legend.
...
<p align="center"><img src="images/plot/option_legend.png" width="600" height="375"></p>

----

<!-- legend_position -->
<a name="plot_option_legend_position"></a>**`legend_position`** - legend position.
By default, `legend_position = "top left"`.

Possible values:
- "top" (same as "top left")
- "right" (same as "top right")
- "bottom" (same as "bottom left")
- "left" (same as "top left")
- "top right"
- "bottom right"
- "top left"
- "bottom left"
...
<p align="center"><img src="images/plot/option_legend_position.png" width="600" height="375"></p>

----

<!-- legend_labels -->
<a name="plot_option_legend_labels"></a>**`legend_labels`** - array of legend labels.
By default, the legend labels will be the data keys/column names. 
...
d3.csv("example2.csv", function(error, data) {
    var options = {
        data: data,
        xkey: "Day",
        legend_labels: ["AAA", "BBB", "CCC"],
    };
    d3lines.plot(svg, options);
});
```

<p align="center"><img src="images/plot/option_legend_labels.png" width="600" height="375"></p>

----

<!-- legend_border_color -->
<a name="plot_option_legend_border_color"></a>**`legend_border_color`** - border color for the legend.
By default, `legend_border_color = "#777"`.
...
<p align="center"><img src="images/plot/option_legend_border_color.png" width="600" height="375"></p>
...
d3.csv("example2.csv", function(error, data) {
    var options = {
        data: data,
        xkey: "Day",
        legend_border_width: 3.5,
    };
    d3lines.plot(svg, options);
});
```

<p align="center"><img src="images/plot/option_legend_border_width.png" width="600" height="375"></p>

----

<!-- legend_border_style -->
<a name="plot_option_legend_border_style"></a>**`legend_border_style`** - border style for the legend.
By default, `legend_border_style = "-"` (solid).
...
<p align="center"><img src="images/plot/option_legend_border_style.png" width="600" height="375"></p>

----

<!-- legend_fill -->
<a name="plot_option_legend_fill"></a>**`legend_fill`** - background color of the legend.
By default, `legend_fill = "white"`.
...
<p align="center"><img src="images/plot/option_legend_fill.png" width="600" height="375"></p>
...
d3.csv("example2.csv", function(error, data) {
    var options = {
        ...
        legend_position: "bottom right",
        legend_fill: "#dfd",
        legend_fill_opacity: 0.9,
    };
    d3lines.plot(svg, options);
});
```

<p align="center"><img src="images/plot/option_legend_fill_opacity.png" width="600" height="375"></p>
...
d3.csv("example2.csv", function(error, data) {
    var options = {
        ...
        legend_font_family: "Palatino, Serif"
    };
    d3lines.plot(svg, options);
});
```

<p align="center"><img src="images/plot/option_legend_font_size.png" width="600" height="375"></p>
